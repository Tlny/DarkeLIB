...
void create() {
	...
	set("long",
		"This is a scroll with many magical words on it. You can type transport home, guild, or church to use it and it will transport you to the location requested."
	);
	set_weight(30);
	set_value(100);
}
...
int transport(string str) {
   ...
   message("info","You use your scroll of Town Square prepare to transport.",
      this_player());
   inf = ({ (str), (this_player()) });
