...
switch(random(7)){
   ...
   set_name("dragon");
   set("id", ({ "dragon", "Dragon", "red dragon", "small dragon" }));
   set("long",
   ...
   set_short("["+zlevel+"]Small %^RESET%^%^RED%^Red%^RESET%^ Dragon");
 ...
 //set_max_hp(100);
    ...
    set_skill("two handed staff", 10*zlevel +random(zlevel));
    set_skill("axe", 10*zlevel +random(zlevel));
    set_skill("blade", 10*zlevel +random(zlevel));
    set_skill("blunt", 10*zlevel +random(zlevel));
    set_skill("knife",  10*zlevel +random(zlevel));
    set_skill("flail", 10*zlevel +random(zlevel));
    set_skill("melee", 10*zlevel +random(zlevel));

    set_skill("parry", 10*zlevel +random(zlevel));
    set_skill("dodge", 10*zlevel +random(zlevel));
    set_skill("block", 10*zlevel +random(zlevel));
/*
    set_skill("combo", 10*zlevel +random(zlevel));
    set_skill("reverse stroke", 10*zlevel +random(zlevel));
    set_skill("perception", 10*zlevel +random(zlevel));

    set_combat_chance(100);

    set_skill("martial arts",10*zlevel +random(zlevel));
    set_skill("shield bash", 10*zlevel +random(zlevel));
    set_skill("reverse stroke", 10*zlevel +random(zlevel)); 
    set_skill("defense", 10*zlevel +random(zlevel));
    set("see invis", 1);

    set_skill("concentrate", 10*zlevel +random(zlevel));
