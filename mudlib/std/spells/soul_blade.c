...
void spell_func(object caster, object at, int power, string args, int flag) {
	...
	ob->set_extra_wc(([ "cold" : 18*power, "unholy" : 18*power, "impaling" : 18*power ]));
	ob->set_auto_crits(([ "cold C" : 8*power, "unholy B" : 8*power, "unholy C" : 4*power, "impaling A" : 8*power, "impaling B" : 8*power, "impaling C" : 4*power]));
