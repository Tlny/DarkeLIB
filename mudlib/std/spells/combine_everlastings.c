...
void info() {
message("help",
"This spell creates a dragon scale. You must cast it with 5 everlastings in the room.\n"
...
void finish_work(object caster, object at, int power) {
  ...
  message("info", "The everlastings combine into a dragon scale.", caster);
  ...
  seteuid(getuid());
  ob = new("/std/diewarzau/obj/misc/dragon_scale");
