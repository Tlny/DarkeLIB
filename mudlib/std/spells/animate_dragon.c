...
void info() {
message("help",
"This spell animates a dragon scale into a dragon, a powerful undead who will serve you as an undead thrall.  "
...
"Syntax: cast *6 animate dragon at body with <lore>\n"
"Ex: cast *6 animate dragon at body with nexus lore\n",
this_player());
}
...
void spell_func(object caster, object at, int power, string args, int flag) {
  ...
  if(!at->id("dragon scale")) {
    message("info", "You must cast this spell at a dragon scale.",
	    caster);
    remove();
    return;
  }
  ...
  if(flag) {
    ...
    message("info", (string)caster->query_cap_name() +
	    " inadvertently destroys a dragon scale.",
...
void finish_work(object caster, object at, int power, int pow) {
  ...
  message("info", (string)caster->query_cap_name() + " utters some "+
	  "necromantic incantations, and a dragon scale "+
  ...
  ob = new("/std/spells/summon/dragon");
